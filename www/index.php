...
<body>
        ...
        <div class="nav-menu">
            <ul class="menu-lists">
                ...
                <li class="list-items animation-submenu list-items-userlist">
                    <a href="./page/monan.php" class="list-user">
                        <div class="icon-listuser-vector-only">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
    ...
    <div id="header-main" class="js-header header">
                <div id="header-menu-main" class="js-header-menu header-menu">
                    ...
                    <button onclick="window.location.href='./page/login.php'" type="button" class="btn-login-danger-index bd-rd-rem ">Sign In</button>
                </div>
    </div>
    <!-- header -->
    <div id="section-content" class="section-content-dashboard">
            <?php 
              foreach($dataphongvip as $phongvip) : ?>
                <div class="content-overview">
                    <a href="./page/login.php" class="link-sales">
            ...
            <?php 
              foreach($dataphongbt as $phongbt) : ?>
                 <div class="content-overview">
                    <a href="./page/login.php" class="link-online">
