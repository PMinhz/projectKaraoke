                            ...
                            <ul class="list-user-page">
                                <div>
                                    ...
                                    <a <?php if($page == 1)
                                                ...
                                                echo "href=./danhsachkhachhang.php?page=1";               
                                        ?>>
                                    ...
                                    <li class="arrow-back-list-user">
                                        <a <?php if($previous<1)
                                                ...
                                                echo "href=./danhsachkhachhang.php?page=".$previous;  
                                        ?>>
                                    ...
                                    <a <?php if($i==$page)
                                                ...
                                                echo "href=./danhsachkhachhang.php?page=".$i;  
                                        ?>>
                                        <div>
                                             <?= $i; ?>
                                        </div>
                                    ...
                                    <a <?php if($next>$pages)
                                                ...
                                                echo "href=./danhsachkhachhang.php?page=".$next;               
                                        ?>>
                                    ...
                                    <a <?php if($page == $pages)
                                                ...
                                                echo "href=./danhsachkhachhang.php?page=".$pages;               
                                        ?>>
